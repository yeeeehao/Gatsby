...
export default function CsGradeTracker() {
  ...
  let [gradeList, setGrageList] = useLocalStorage("gradeList", [])
  let [gpa, setGpa] = useLocalStorage("gpaList", [])
  let [totalGpa, setTotalGpa] = useLocalStorage("totalGpa", 0)
  let [totalNum, setTotalNum] = useLocalStorage("totalCourse", 0)
